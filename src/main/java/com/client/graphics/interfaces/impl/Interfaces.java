...
//	}
	...
	private static void barrowsKillcount(TextDrawingArea[] tda) {
		RSInterface barrow = addInterface(29500);
		addText(29501, "Brothers", tda, 2, 0xFD851A, true, true);
		addText(29502, "Ahrim", tda, 0, 0xFD851A, true, true);
		addText(29503, "Dharok", tda, 0, 0xFD851A, true, true);
		addText(29504, "Guthan", tda, 0, 0xFD851A, true, true);
		addText(29505, "Karil", tda, 0, 0xFD851A, true, true);
		addText(29506, "Torag", tda, 0, 0xFD851A, true, true);
		addText(29507, "Verac", tda, 0, 0xFD851A, true, true);
		addText(29508, "Killcount", tda, 2, 0xFD851A, true, true);
		addText(29509, "0", tda, 0, 0xFD851A, true, true);
		setChildren(9, barrow);
		setBounds(29501, 470, 42, 0, barrow);
		for (int index = 1; index < 7; index++)
			setBounds(29501 + index, 470, 45 + index * 14, index, barrow);
		setBounds(29508, 470, 15, 7, barrow);
		setBounds(29509, 470, 30, 8, barrow);
	}
...
interfaceId+=5000;
	...
	public static void musictab(TextDrawingArea[] tda) {
		RSInterface scroll = interfaceCache[4262];
		scroll.scrollMax = 11940;
		scroll.width = 168;
		scroll.height = 190;
		setChildren(796, scroll);
	...
	public static void itemsOnDeathDATA(TextDrawingArea[] wid) {
	    ...
	    // Use newFonts[0] instead of Client.instance.newSmallFont
	    addStringContainer(17109, 17115, newFonts[0], // This should be the small font
