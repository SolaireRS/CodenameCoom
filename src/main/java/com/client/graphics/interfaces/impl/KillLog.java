...
public class KillLog extends RSInterface {
    ...
    private int container(int interfaceId) {
        ...
        addStringContainer(interfaceId, container.id, newFonts[1], false, RSInterface.DEFAULT_TEXT_COLOR, true, 18, "Commander Zilyana");
        ...
        addStringContainer(interfaceId, container.id, newFonts[1], false, RSInterface.DEFAULT_TEXT_COLOR, true, 18, "100");
        get(interfaceId).invAutoScrollHeightOffset = 18;
        ...
        addStringContainer(interfaceId, container.id, newFonts[1], false, RSInterface.DEFAULT_TEXT_COLOR, true, 18, "15:00");
        get(interfaceId).invAutoScrollHeightOffset = 18;
